...
?>
    ...
    <section class="food-search text-center">
        <div class="container">
            ...
            <h4>your daily need products</h4>
    ...
    <section class="categories">
        <div class="container">
            <h2 class="text-center">Shop by <span>Categories</span> </h2>
                            ...
                            <div class="box-3 float-container">
                                <?php 
                                    ...
                                    else
                                    {
                                        //Image Available
                                        ?>
                                        <img src="<?php echo SITEURL; ?>images/category/<?php echo $image_name; ?>" alt="Pizza" class="img-responsive img-curvee">
                                        <?php
                                    }
                                ?>
    ...
    <section class="food-menu">
        <div class="container">
            <h2 class="text-center">Latest <span>Products</span></h2>
